...
def generate_dfs_list(df, domain):
    ...
    print("\nlongtail keywords in positions 20-100")
    longtails_keywords20_12 = df_longtails_12[df_longtails_12["position"].between(20, 100)]
    ...
    dfs_dict = {
        ...
        "Longtails 5-20 8+W": longtails_keywords20_8,
...
def query_gsc(domain, lookback_days=90, sort_by=["impressions"]):
    ...
    print("\nPut the .gz database file generated by Updraft in the data/" + domain + "/ folder and press any key.")
    input()
